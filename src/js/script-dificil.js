...
/**--------------------------------------------------------------------------------------------------------- */
// Función para generar números aleatorios entre 0 y 9999
function generarNumeroAleatorio() {
  return Math.floor(Math.random() * 9999) + 0;
}
...
function drop(event) {
  ...
  if (numeroAleatorio1 > numeroAleatorio2) {
    if (signo === "mayor") {
      ...
      updateProgressBar();
      // Si alcanzó 10 respuestas correctas, mostrar una alerta y se devuelve al index
    ...
    if (signo === "menor") {
      ...
      respuestasCorrectas++;
      updateProgressBar();
      // Si alcanzó 10 respuestas correctas, mostrar una alerta y se devuelve al indez
      if (respuestasCorrectas === 10) {
        alert("¡GANASTE!");
        setTimeout(function () {
          window.location.href = 'index.html';
  ...
  if (signo === "mayor" || signo === "igual" || signo === "menor") {
    ...
    listItem.textContent = `${respuesta.numeroAleatorio1} es ${respuesta.signo} que ${respuesta.numeroAleatorio2}, Respuesta: ${respuesta.correcta ? "Correcta" : "Incorrecta"}`;
